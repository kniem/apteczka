<div id="navbar" class="navbar-collapse collapse" id="Moje menu">
    <ul class="nav navbar-nav">
		<li><a href="index.php?wybrano=0"><?php echo $menuAp;?></a></li>
        <li><a href="baza_lekow.php?wybrano=2"><?php echo $menuBaza;?></a></li>
